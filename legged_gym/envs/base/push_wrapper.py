...
class PushConfig:
    def __init__(self,
        ...
        self._config_info = {
            ...
            'config:push_interval':self.push_interval,
...
class EvalWrapper():
    ...
    def step(self, action,random_push = False):
    ...
    def get_result(self):
        ...
        for config in self.eval_config:
            ...
            push_interval.append(config.push_interval)
        self.eval_res['max_force'] = max(force_list)
        self.eval_res['push_interval'] = min(push_interval)
